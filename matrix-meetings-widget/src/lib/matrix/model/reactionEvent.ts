...
// based on https://github.com/matrix-org/matrix-spec/blob/03cdea4b57320926a6da73ad3b3f6c7f4fd0a7c2/data/event-schemas/schema/m.reaction.yaml
const reactionEventSchema = Joi.object<ReactionEvent, true>({
  'm.relates_to': Joi.object({
    ...
    .unknown()
    .required(),
  'net.nordeck.meetings.bot.meta': Joi.object({
...
): event is StateEvent<ReactionEvent> {
